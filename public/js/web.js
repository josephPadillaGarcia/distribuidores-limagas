...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    localePath: function localePath(object) {
      var locale = this.getLocale() === "es" ? "" : this.getLocale();
      var name = object.name,
          _object$params = object.params,
          params = _object$params === void 0 ? null : _object$params;
      var addSlug = params ? "/".concat(params.slug) : "";
      var path = "".concat(locale, "/").concat(name).concat(addSlug);
      return path;
    },
...
Vue.mixin(_mixins__WEBPACK_IMPORTED_MODULE_1__["default"]);
var app = new Vue({
  el: '#app',
  components: {
    /** Para web */
    AppTracking: function AppTracking() {
      return __webpack_require__.e(/*! import() | js/components/app-tracking */ "js/components/app-tracking").then(__webpack_require__.bind(null, /*! ./components/AppTracking.vue */ "./resources/js/web/components/AppTracking.vue"));
    },
    Banner: function Banner() {
      return __webpack_require__.e(/*! import() | js/components/banner */ "js/components/banner").then(__webpack_require__.bind(null, /*! ./components/Banner.vue */ "./resources/js/web/components/Banner.vue"));
    },
    Customers: function Customers() {
      return Promise.all(/*! import() | js/components/customers */[__webpack_require__.e("vendors~js/components/customers~js/pages/web/about-us~js/pages/web/index~js/pages/web/service"), __webpack_require__.e("js/components/customers")]).then(__webpack_require__.bind(null, /*! ./components/Customers.vue */ "./resources/js/web/components/Customers.vue"));
    },
    Dropdown: function Dropdown() {
      return Promise.all(/*! import() | js/components/dropdown */[__webpack_require__.e("vendors~js/components/dropdown"), __webpack_require__.e("js/components/dropdown")]).then(__webpack_require__.bind(null, /*! ./components/Dropdown.vue */ "./resources/js/web/components/Dropdown.vue"));
    },
    IconClose: function IconClose() {
      return __webpack_require__.e(/*! import() | js/components/icon-close */ "js/components/icon-close").then(__webpack_require__.bind(null, /*! ./components/icons/Close.vue */ "./resources/js/web/components/icons/Close.vue"));
    },
    ItemService: function ItemService() {
      return __webpack_require__.e(/*! import() | js/components/item-service */ "js/components/item-service").then(__webpack_require__.bind(null, /*! ./components/items/ItemService.vue */ "./resources/js/web/components/items/ItemService.vue"));
    },
    ...
    FormQuote: function FormQuote() {
      return Promise.all(/*! import() | js/components/form-quote */[__webpack_require__.e("js/components/form-quote~js/pages/web/quotations~js/pages/web/service"), __webpack_require__.e("js/components/form-quote")]).then(__webpack_require__.bind(null, /*! ./components/FormQuote.vue */ "./resources/js/web/components/FormQuote.vue"));
    },
    WebFooter: function WebFooter() {
      return __webpack_require__.e(/*! import() | js/components/web-footer */ "js/components/web-footer").then(__webpack_require__.bind(null, /*! ./components/layout/Footer.vue */ "./resources/js/web/components/layout/Footer.vue"));
    },
    WebMenu: function WebMenu() {
      return __webpack_require__.e(/*! import() | js/components/web-menu */ "js/components/web-menu").then(__webpack_require__.bind(null, /*! ./components/layout/Menu.vue */ "./resources/js/web/components/layout/Menu.vue"));
    },
    WebIndex: function WebIndex() {
      return Promise.all(/*! import() | js/pages/web/index */[__webpack_require__.e("vendors~js/components/customers~js/pages/web/about-us~js/pages/web/index~js/pages/web/service"), __webpack_require__.e("js/pages/web/index")]).then(__webpack_require__.bind(null, /*! ./views/Index.vue */ "./resources/js/web/views/Index.vue"));
    },
    WebAboutUs: function WebAboutUs() {
      return Promise.all(/*! import() | js/pages/web/about-us */[__webpack_require__.e("vendors~js/components/customers~js/pages/web/about-us~js/pages/web/index~js/pages/web/service"), __webpack_require__.e("js/pages/web/about-us")]).then(__webpack_require__.bind(null, /*! ./views/AboutUs.vue */ "./resources/js/web/views/AboutUs.vue"));
    },
    WebPrivacyPolicies: function WebPrivacyPolicies() {
      return __webpack_require__.e(/*! import() | js/pages/web/privacy-policies */ "js/pages/web/privacy-policies").then(__webpack_require__.bind(null, /*! ./views/PrivacyPolicies.vue */ "./resources/js/web/views/PrivacyPolicies.vue"));
    },
    WebQuotations: function WebQuotations() {
      return Promise.all(/*! import() | js/pages/web/quotations */[__webpack_require__.e("js/components/form-quote~js/pages/web/quotations~js/pages/web/service"), __webpack_require__.e("js/pages/web/quotations")]).then(__webpack_require__.bind(null, /*! ./views/Quotations.vue */ "./resources/js/web/views/Quotations.vue"));
    },
    WebServices: function WebServices() {
      return __webpack_require__.e(/*! import() | js/pages/web/services */ "js/pages/web/services").then(__webpack_require__.bind(null, /*! ./views/Services.vue */ "./resources/js/web/views/Services.vue"));
    },
    WebService: function WebService() {
      return Promise.all(/*! import() | js/pages/web/service */[__webpack_require__.e("vendors~js/components/customers~js/pages/web/about-us~js/pages/web/index~js/pages/web/service"), __webpack_require__.e("js/components/form-quote~js/pages/web/quotations~js/pages/web/service"), __webpack_require__.e("js/pages/web/service")]).then(__webpack_require__.bind(null, /*! ./views/Service.vue */ "./resources/js/web/views/Service.vue"));
    }
  },
...
module.exports = __webpack_require__(/*! /home/jefry/Escritorio/proyectos-personales/dinet-e-commerce-cms/resources/js/web/web.js */"./resources/js/web/web.js");
