...
namespace App\Http\Controllers\Cms\Noticia;
...
class PostsController extends Controller
{
    ...
    {
        return view("admin.pages.noticia.posts.index");
    }
    ...
    {
        return view("admin.pages.noticia.posts.create");
    }
    ...
    public function edit(Post $element)
    {
        ...
        return view("admin.pages.noticia.posts.edit", compact('element'));
    }
    ...
    public function store(PostRequest $request)
    {
        ...
        if (!$storeImage || !$storeThumbnail) {
            ...
            return response()->json(["route" => route('cms.noticia.posts.index')], 500);
        }
        ...
        try {
            ...
            return response()->json(["route" => route('cms.noticia.posts.index')]);
        } catch (\Exception $e) {
            $request->session()->flash('error', trans('custom.message.create.error', ['name' => trans('custom.attribute.post')]));
            return response()->json(["route" => route('cms.noticia.posts.index')], 500);
        }
