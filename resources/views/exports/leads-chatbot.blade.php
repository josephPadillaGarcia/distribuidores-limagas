...
<table style="border: 1px solid black;">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td style="text-align:center;vertical-align:middle;border: 1px solid black;">{{ $lead->project }} </td>
   <td style="text-align:center;vertical-align:middle;border: 1px solid black;">{{ $lead->host }} </td>
