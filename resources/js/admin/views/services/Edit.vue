                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <div
                        ...
                        v-if="elementParent.image"
                      >
                        <img
                          class="img-fluid bg-dark p-1"
                          :src="imagesUrl + '/services/' + elementParent.image"
                          alt
                        />
                      </div>
                      <div
                        class=""
                        :class="elementParent.image ? 'col-lg-8' : 'col-12'"
                      >
                        <ImageForm
                          label="Imagen"
                          variable="image"
                  ...
                  <div class="col-12 col-lg-6  mb-4 vue-dropzone-dark">
                    ...
                    <div class="row">
                      ...
                      <div
                        class=""
                        :class="elementParent.icon_white ? 'col-lg-8' : 'col-12'"
                      >
                        <vue-dropzone
                          ref="ref_icon_white"
                  ...
                  <div class="col-12 col-lg-6 mb-4">
                    ...
                    <div class="row">
                      ...
                      >
                        <img
                          class="img-fluid"
                          :src="imagesUrl + '/services/' + elementParent.icon_colour"
                          alt
                        />
                      </div>
                      <div
                        class=""
                        :class="elementParent.icon_colour ? 'col-lg-8' : 'col-12'"
                      >
                        <vue-dropzone
                          ref="ref_icon_color"
                          @vdropzone-file-added="
